...
stack_template::stack_template(char ch)
{
 ...
 */
void stack_template::push(char ch)
{
 ...
 */
ADS101::CharNode *stack_template::getHead()
{
    return head;
}
